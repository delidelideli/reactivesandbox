...
const THEMES = {
  ...
  skyrim: {
    label: 'Skyrim',
    swatch: ['#0c0a07', '#c8960a', '#5a7a90', '#7a3878'],
    bodyClass: 'theme-skyrim',
    vars: {
      '--accent-gold':         '#c8960a',
      '--accent-gold-light':   '#e0b020',
      '--accent-blue':         '#5a7a90',
      '--accent-blue-light':   '#7898aa',
      '--accent-purple':       '#7a3878',
      '--accent-purple-light': '#9858a0',
      '--text-color':          '#c8c0aa',
      '--text-gold':           '#c8960a',
      '--text-purple':         '#9858a0',
      '--font-family':         "'IM Fell English', serif",
      '--panel-spacing':       '0.75rem',
      '--bg-primary':          '#0c0a07',
      '--bg-glow-color':       'rgba(60,45,10,0.2)',
      '--panel-glow':          'rgba(200,150,10,0.09)',
      '--grimoire-glow':       'rgba(90,122,144,0.10)',
      '--border-panels-rgb':   '90,122,144',
      '--border-cauldron-rgb': '200,150,10',
      '--stat-potency-color':  '#c8960a',
      '--stat-toxicity-color': '#9858a0',
    },
  },
  crimson: {
